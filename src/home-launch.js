          ...
          <Grid container>
            <Grid.Row>
              <Grid.Column width={8} mobile={12} tablet={8} computer={8}>
                ...
                />
              <br /><br />
              <Link to="/confess"><Button primary size='big' className='btn-dark'>Confess Now</Button></Link>
            ...
            <Grid.Row>
              <Grid.Column width={16}>
                ...
                <Header
                  ...
                  style={{ fontSize: '2.5em', fontWeight: 'normal', marginTop: '0em', textAlign: 'center' }}
                />
                <br />
              </Grid.Column>
            </Grid.Row>
